...
function ChangePassword() {
    ...
    const [newCfPW, setNewCfPW] = useState<string>("")
    const [msgNewPW, setMsgNewPW] = useState<string>("")
    const [msgNewCfPW, setMsgCfNewPW] = useState<string>("")
    ...
    const onChangeCurrentPW:ChangeEventHandler = (e) => {//xử lý khi nhập mật khẩu
        setCurrentPW(e.target.value)
    }
    const onChangeNewPW:ChangeEventHandler = (e) => {//xử lý khi nhập mật khẩu mới
    ...
    const onChangeNewCfPW:ChangeEventHandler = (e) => {//xử lý nhập mật khẩu xác nhận
    ...
    const onClickChangePassword:ClickEventHandler = async (e) => {//xử lý gọi API đổi mật khẩu
        e.preventDefault()
        ...
        <div className="profile__main">
            <form>
                ...
                <div className="d-flex">
                    <button onClick={onClickChangePassword}>{isLoading ? <Loading/> : ''} Đổi mật khẩu</button>
                </div>
            </form>
